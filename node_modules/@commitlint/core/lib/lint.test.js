...
(0, _ava2.default)('throws without params', function (t) {
	return new Promise(function ($return, $error) {
		var error;
		return Promise.resolve(t.throws((0, _lint2.default)())).then(function ($await_1) {
			try {
				error = $await_1;
...
(0, _ava2.default)('throws with empty message', function (t) {
	return new Promise(function ($return, $error) {
		var error;
		return Promise.resolve(t.throws((0, _lint2.default)(''))).then(function ($await_2) {
			try {
				error = $await_2;
				t.is(error.message, 'Expected a raw commit');
				return $return();
...
(0, _ava2.default)('positive on stub message and no rule', function (t) {
	return new Promise(function ($return, $error) {
		var actual;
		return Promise.resolve((0, _lint2.default)('foo: bar')).then(function ($await_3) {
			try {
				actual = $await_3;
				t.true(actual.valid);
				return $return();
...
(0, _ava2.default)('throws for invalid rule names', function (t) {
	return new Promise(function ($return, $error) {
		var error;
		return Promise.resolve(t.throws((0, _lint2.default)('foo', { foo: [2, 'always'], bar: [1, 'never'] }))).then(function ($await_8) {
			try {
				error = $await_8;
...
(0, _ava2.default)('throws for invalid rule config', function (t) {
	return new Promise(function ($return, $error) {
		var error;
		return Promise.resolve(t.throws((0, _lint2.default)('type(scope): foo', {
			'type-enum': 1,
...
(0, _ava2.default)('allows disable shorthand', function (t) {
	return new Promise(function ($return, $error) {
		return Promise.resolve(t.notThrows((0, _lint2.default)('foo', { 'type-enum': [0], 'scope-enum': [0] }))).then(function ($await_10) {
			try {
				return $return();
			} catch ($boundEx) {
				return $error($boundEx);
...
(0, _ava2.default)('throws for rule with invalid length', function (t) {
	return new Promise(function ($return, $error) {
		var error;
		return Promise.resolve(t.throws((0, _lint2.default)('type(scope): foo', { 'scope-enum': [1, 2, 3, 4] }))).then(function ($await_11) {
			try {
				error = $await_11;
...
(0, _ava2.default)('succeds for issue', function (t) {
	return new Promise(function ($return, $error) {
		var report;
		return Promise.resolve((0, _lint2.default)('somehting #1', {
...
(0, _ava2.default)('succeds for custom issue prefix', function (t) {
	return new Promise(function ($return, $error) {
		var report;
		return Promise.resolve((0, _lint2.default)('somehting REF-1', {
			'references-empty': [2, 'never']
		}, {
			parserOpts: {
				issuePrefixes: ['REF-']
