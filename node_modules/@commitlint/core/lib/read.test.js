			...
			try {
				...
				return Promise.resolve(sander.writeFile(cwd, 'commit-msg-file', 'foo')).then(function ($await_2) {
					try {
						...
						expected = ['foo\n'];
						return Promise.resolve((0, _read2.default)({ edit: 'commit-msg-file', cwd })).then(function ($await_3) {
							try {
								actual = $await_3;
						...
						return Promise.resolve((0, _execa2.default)('git', ['add', '.'], { cwd })).then(function ($await_6) {
							try {
								return Promise.resolve((0, _execa2.default)('git', ['commit', '-m', 'alpha'], { cwd })).then(function ($await_7) {
									try {
										expected = ['alpha\n\n'];
										return Promise.resolve((0, _read2.default)({ edit: true, cwd })).then(function ($await_8) {
											try {
												actual = $await_8;
												t.deepEqual(actual, expected);
												return $return();
											...
											try {
												return Promise.resolve((0, _execa2.default)('git', ['commit', '-m', 'remove alpha'], { cwd })).then(function ($await_14) {
													try {
														...
														return Promise.resolve((0, _read2.default)({ cwd })).then(function ($await_15) {
															try {
																actual = $await_15;
																t.deepEqual(actual, expected);
																return $return();
									...
									try {
										return Promise.resolve((0, _execa2.default)('git', ['commit', '-m', 'beta'], { cwd })).then(function ($await_20) {
											try {
												...
												expected = ['beta\n\n'];
												return Promise.resolve((0, _read2.default)({ edit: true, cwd })).then(function ($await_21) {
													try {
														actual = $await_21;
														t.deepEqual(actual, expected);
														return $return();
